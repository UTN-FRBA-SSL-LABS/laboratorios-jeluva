...
/* 'item' solo imprime y no propaga un valor semántico hacia arriba, pero
 * se declara con un tipo para dejar explícito el contrato de la producción. */
%type <int_val> item
